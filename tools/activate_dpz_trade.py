"""
DPZ (Domino's Pizza, $12.1B) 52-Week Low Catalyst Short Activation Script
========================================================================
ONLY activate on April 27 2026 if:
  1. DPZ opens down >2% abnormal vs prior close (earnings miss confirmed)
  2. DPZ is at or below its 52-week low ($360.09)
  3. Portfolio has capacity (<5 active trades)

HYPOTHESIS: dc68dfc3 (sp500_52w_low_catalyst_short, 5d hold)
Expected: -4.44% abnormal over 5 days

Usage:
  python tools/activate_dpz_trade.py [--dry-run] [--yes]
"""
